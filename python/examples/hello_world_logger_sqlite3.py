...
from chaincrafter.loggers import LoggerSqlite3

path = os.path.dirname(__file__)
data_logger = LoggerSqlite3(os.path.join(path, "hello_world_logger_sqlite3.db"))
data_logger.create_tables()
...
chain.set_data_logger(data_logger)
